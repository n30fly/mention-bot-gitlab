...
app.post('/', function(req, res) {
  ...
  req.pipe(bl(function(err, body) {
    ...
    request({
        url : process.env.GITLAB_URL + '/api/v4/projects/' + data.object_attributes.target_project_id + '/merge_requests/' + data.object_attributes.iid + '/changes',
        headers : {
        ...
        mentionBot.guessOwnersForPullRequest(
          ...
          request.post({
                url : process.env.GITLAB_URL + '/api/v4/projects/' + data.object_attributes.target_project_id + '/merge_requests/' + data.object_attributes.iid + '/notes',
                body: JSON.stringify({
